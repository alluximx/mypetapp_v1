...
export const ListItemIconShowcase = (
  props?: ListItemProps,
): ListItemElement => <ListItem icon={StarIcon} {...props} />;

export const ListItemAccessoryShowcase = (
  props?: ListItemProps,
): ListItemElement => <ListItem {...props} accessory={AccessoryElement} />;
...
export const ListItemIconAccessoryShowcase = (
  ...
  <ListItem
    {...props}
    icon={StarIcon}
    accessory={(style, index) => (
      <AccessoryElement style={style} index={index} />
    )}
  />
);
