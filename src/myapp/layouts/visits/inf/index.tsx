  ...
  const data = [
    {
      ...
      content:
        'El veterinario dijo que era una reacción normal por la vacuna que le pussieron.',
      buttonText: 'Editar',
      buttonAlign: 'right',
    ...
    },
    {
      ...
      content:
        'Hay que llevar a Valerio a una terapia especial para que se pueda recuperar totalmemte y no siga cojeando. El veterinario va a pasar el contacto de una clínica especializada.',
      buttonText: 'Editar',
      buttonAlign: 'right',
      images: ['../assets/dog-visit.png', '../assets/dog-visit.png'],
      styleCard: {},
